...
export class NonMarkupOutputException extends UnexpectedTypeException {
    static EXPECTED_TYPES : Array<any>; public static EXPECTED_TYPES_$LI$() : Array { if(NonMarkupOutputException.EXPECTED_TYPES == null) NonMarkupOutputException.EXPECTED_TYPES = ["freemarker.core.TemplateMarkupOutputModel"]; return NonMarkupOutputException.EXPECTED_TYPES; };
