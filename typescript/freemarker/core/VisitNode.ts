 ...
 * @class
 */
export class VisitNode extends TemplateElement {
    ...
    accept(env : Environment) : TemplateElement[] {
        ...
        env.invokeNodeHandlerFor(<TemplateNodeModel><any>node, <TemplateSequenceModel><any>nss);
        return null;
    }
...
VisitNode["__class"] = "freemarker.core.VisitNode";
