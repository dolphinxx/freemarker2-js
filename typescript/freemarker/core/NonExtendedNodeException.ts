...
export class NonExtendedNodeException extends UnexpectedTypeException {
    static EXPECTED_TYPES : Array<any>; public static EXPECTED_TYPES_$LI$() : Array { if(NonExtendedNodeException.EXPECTED_TYPES == null) NonExtendedNodeException.EXPECTED_TYPES = ["freemarker.template.TemplateNodeModelEx"]; return NonExtendedNodeException.EXPECTED_TYPES; };
