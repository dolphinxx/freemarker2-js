...
import { _DelayedGetCanonicalForm } from './_DelayedGetCanonicalForm';
...
export class EvalUtil {
     ...
     * @return {String}
     */
    static modelToString(model : TemplateScalarModel, expr : Expression, env : Environment) : string {
     ...
     * @return {Number}
     */
    static modelToNumber(model : TemplateNumberModel, expr : Expression) : number {
     ...
     * @return {Date}
     */
    static modelToDate(model : TemplateDateModel, expr : Expression) : Date {
     ...
     */
    static newModelHasStoredNullException(expected : any, model : TemplateModel, expr : Expression) : TemplateModelException {
    ...
    static compare$freemarker_core_Expression$int$java_lang_String$freemarker_core_Expression$freemarker_core_Expression$freemarker_core_Environment(leftExp : Expression, operator : number, operatorString : string, rightExp : Expression, defaultBlamed : Expression, env : Environment) : boolean {
    ...
    static compare$freemarker_template_TemplateModel$int$freemarker_template_TemplateModel$freemarker_core_Environment(leftValue : TemplateModel, operator : number, rightValue : TemplateModel, env : Environment) : boolean {
     ...
     * @return {boolean}
     */
    static compareLenient(leftValue : TemplateModel, operator : number, rightValue : TemplateModel, env : Environment) : boolean {
    ...
    public static compare$freemarker_template_TemplateModel$freemarker_core_Expression$int$java_lang_String$freemarker_template_TemplateModel$freemarker_core_Expression$freemarker_core_Expression$boolean$boolean$boolean$boolean$freemarker_core_Environment(leftValue : TemplateModel, leftExp : Expression, operator : number, operatorString : string, rightValue : TemplateModel, rightExp : Expression, defaultBlamed : Expression, quoteOperandsInErrors : boolean, typeMismatchMeansNotEqual : boolean, leftNullReturnsFalse : boolean, rightNullReturnsFalse : boolean, env : Environment) : boolean {
        if(leftValue == null) {
            if(env != null && env.isClassicCompatible()) {
    ...
    public static compare(leftValue? : any, leftExp? : any, operator? : any, operatorString? : any, rightValue? : any, rightExp? : any, defaultBlamed? : any, quoteOperandsInErrors? : any, typeMismatchMeansNotEqual? : any, leftNullReturnsFalse? : any, rightNullReturnsFalse? : any, env? : any) : any {
        ...
        } else if(((leftValue != null && leftValue instanceof <any>Expression) || leftValue === null) && ((typeof leftExp === 'number') || leftExp === null) && ((typeof operator === 'string') || operator === null) && ((operatorString != null && operatorString instanceof <any>Expression) || operatorString === null) && ((rightValue != null && rightValue instanceof <any>Expression) || rightValue === null) && ((rightExp != null && rightExp instanceof <any>Environment) || rightExp === null) && defaultBlamed === undefined && quoteOperandsInErrors === undefined && typeMismatchMeansNotEqual === undefined && leftNullReturnsFalse === undefined && rightNullReturnsFalse === undefined && env === undefined) {
    ...
    static coerceModelToStringOrMarkup$freemarker_template_TemplateModel$freemarker_core_Expression$java_lang_String$freemarker_core_Environment(tm : TemplateModel, exp : Expression, seqTip : string, env : Environment) : any {
    ...
    public static coerceModelToStringOrMarkup$freemarker_template_TemplateModel$freemarker_core_Expression$boolean$java_lang_String$freemarker_core_Environment(tm : TemplateModel, exp : Expression, returnNullOnNonCoercableType : boolean, seqTip : string, env : Environment) : any {
    ...
    public static coerceModelToStringOrMarkup(tm? : any, exp? : any, returnNullOnNonCoercableType? : any, seqTip? : any, env? : any) : any {
        if(((tm != null && (tm["__interfaces"] != null && tm["__interfaces"].indexOf("freemarker.template.TemplateModel") >= 0 || tm.constructor != null && tm.constructor["__interfaces"] != null && tm.constructor["__interfaces"].indexOf("freemarker.template.TemplateModel") >= 0)) || tm === null) && ((exp != null && exp instanceof <any>Expression) || exp === null) && ((typeof returnNullOnNonCoercableType === 'boolean') || returnNullOnNonCoercableType === null) && ((typeof seqTip === 'string') || seqTip === null) && ((env != null && env instanceof <any>Environment) || env === null)) {
     ...
     * @param {Environment} env
     */
    static coerceModelToStringOrUnsupportedMarkup(tm : TemplateModel, exp : Expression, seqTip : string, env : Environment) : string {
        if(tm != null && (tm["__interfaces"] != null && tm["__interfaces"].indexOf("freemarker.template.TemplateNumberModel") >= 0 || tm.constructor != null && tm.constructor["__interfaces"] != null && tm.constructor["__interfaces"].indexOf("freemarker.template.TemplateNumberModel") >= 0)) {
            let tnm : TemplateNumberModel = <TemplateNumberModel><any>tm;
            let format : TemplateNumberFormat = env.getTemplateNumberFormat$freemarker_core_Expression$boolean(exp, false);
            try {
     ...
     * @param {Environment} env
     */
    static coerceModelToPlainText(tm : TemplateModel, exp : Expression, seqTip : string, env : Environment) : string {
        if(tm != null && (tm["__interfaces"] != null && tm["__interfaces"].indexOf("freemarker.template.TemplateNumberModel") >= 0 || tm.constructor != null && tm.constructor["__interfaces"] != null && tm.constructor["__interfaces"].indexOf("freemarker.template.TemplateNumberModel") >= 0)) {
     ...
     * @private
     */
    /*private*/ static coerceModelToTextualCommon(tm : TemplateModel, exp : Expression, seqHint : string, supportsTOM : boolean, returnNullOnNonCoercableType : boolean, env : Environment) : string {
    ...
    /*private*/ static ensureFormatResultString(formatResult : any, exp : Expression, env : Environment) : string {
        ...
        if(rightOF !== leftOF) {
            ...
            if((rightPT = rightOF.getSourcePlainText(rightMO)) != null) {
                ...
                if(parent != null && parent instanceof <any>Expression) {
                    throw <any>new (__Function.prototype.bind.apply(_MiscTemplateException, [null, <Expression>parent].concat(<any[]>message)));
                } else {
     ...
     */
    static getArithmeticEngine(env : Environment, tObj : TemplateObject) : ArithmeticEngine {
        return env != null?env.getArithmeticEngine():tObj.getTemplate().getParserConfiguration().getArithmeticEngine();
    }

    static shouldWrapUncheckedException(e : Error, env : Environment) : boolean {
        ...
        if(env.getWrapUncheckedExceptions()) {
            ...
            return c === java.lang.NullPointerException || c === java.lang.ClassCastException || c === java.lang.IndexOutOfBoundsException || c === InvocationTargetException;
        } else {
            return false;
        }
    }
