...
export class NonHashException extends UnexpectedTypeException {
    static EXPECTED_TYPES : Array<any>; public static EXPECTED_TYPES_$LI$() : Array { if(NonHashException.EXPECTED_TYPES == null) NonHashException.EXPECTED_TYPES = ["freemarker.template.TemplateHashModel"]; return NonHashException.EXPECTED_TYPES; };
