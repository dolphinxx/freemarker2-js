    ...
    public constructor(blamed? : any, model? : any, tip? : any, env? : any) {
        if(arguments[0] instanceof Expression) {
            if(arguments.length === 3) {
                super(arguments[0], arguments[1], "hash", NonHashException.EXPECTED_TYPES, arguments[2]);
                return;
            }
            super(arguments[0], arguments[1], "hash", NonHashException.EXPECTED_TYPES, arguments[2], arguments[3]);
            return;
        }
        ...
        super(arguments[0], "Expecting hash value here");
