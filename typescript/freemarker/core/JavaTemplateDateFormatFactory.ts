...
export class JavaTemplateDateFormatFactory extends TemplateDateFormatFactory {
    ...
    static GLOBAL_FORMAT_CACHE : ConcurrentHashMap; public static GLOBAL_FORMAT_CACHE_$LI$() : ConcurrentHashMap { if(JavaTemplateDateFormatFactory.GLOBAL_FORMAT_CACHE == null) JavaTemplateDateFormatFactory.GLOBAL_FORMAT_CACHE = <any>(<Map<JavaTemplateDateFormatFactory.CacheKey, DateFormat>>new Map<JavaTemplateDateFormatFactory.CacheKey, DateFormat>()); return JavaTemplateDateFormatFactory.GLOBAL_FORMAT_CACHE; };
     ...
     * @private
     */
    getJavaDateFormat(dateType : number, nameOrPattern : string, locale : string, timeZone : string) : DateFormat {
...
JavaTemplateDateFormatFactory.GLOBAL_FORMAT_CACHE_$LI$();
