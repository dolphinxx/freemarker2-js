...
import { ExtendedDecimalFormatParser } from './ExtendedDecimalFormatParser';
...
export class JavaTemplateNumberFormatFactory extends TemplateNumberFormatFactory {
    ...
    static GLOBAL_FORMAT_CACHE : ConcurrentHashMap; public static GLOBAL_FORMAT_CACHE_$LI$() : ConcurrentHashMap { if(JavaTemplateNumberFormatFactory.GLOBAL_FORMAT_CACHE == null) JavaTemplateNumberFormatFactory.GLOBAL_FORMAT_CACHE = <any>(<Map<JavaTemplateNumberFormatFactory.CacheKey, NumberFormat>>new Map<JavaTemplateNumberFormatFactory.CacheKey, NumberFormat>()); return JavaTemplateNumberFormatFactory.GLOBAL_FORMAT_CACHE; };
    ...
    public get(params : string, locale : string, env : Environment) : TemplateNumberFormat {
        ...
        let jFormat : NumberFormat = /* get */JavaTemplateNumberFormatFactory.GLOBAL_FORMAT_CACHE_$LI$().get(cacheKey);
        if(jFormat == null) {
...
JavaTemplateNumberFormatFactory.GLOBAL_FORMAT_CACHE_$LI$();
