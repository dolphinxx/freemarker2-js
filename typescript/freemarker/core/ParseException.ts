 ...
 * @extends Error
 */
export class ParseException implements FMParserConstants {
    /**
    ...
    /*private*/ messageAndDescriptionRendered : boolean;
    ...
    public constructor(description? : any, template? : any, lineNumber? : any, columnNumber? : any, endLineNumber? : any, endColumnNumber? : any, cause? : any) {
        if(((typeof description === 'string') || description === null) && ((template != null && template instanceof <any>Template) || template === null) && ((typeof lineNumber === 'number') || lineNumber === null) && ((typeof columnNumber === 'number') || columnNumber === null) && ((typeof endLineNumber === 'number') || endLineNumber === null) && ((typeof endColumnNumber === 'number') || endColumnNumber === null) && ((cause != null && (cause["__classes"] && cause["__classes"].indexOf("java.lang.Throwable") >= 0) || cause != null && cause instanceof <any>Error) || cause === null)) {
        ...
        } else if(((typeof description === 'string') || description === null) && ((template != null && template instanceof <any>Template) || template === null) && ((typeof lineNumber === 'number') || lineNumber === null) && ((typeof columnNumber === 'number') || columnNumber === null) && ((typeof endLineNumber === 'number') || endLineNumber === null) && ((typeof endColumnNumber === 'number') || endColumnNumber === null) && cause === undefined) {
            let __args = Array.prototype.slice.call(arguments);
            {
                let __args = Array.prototype.slice.call(arguments);
                let cause : any = null;
        ...
        } else if(((typeof description === 'string') || description === null) && ((template != null && template instanceof <any>Template) || template === null) && ((typeof lineNumber === 'number') || lineNumber === null) && ((typeof columnNumber === 'number') || columnNumber === null) && ((endLineNumber != null && (endLineNumber["__classes"] && endLineNumber["__classes"].indexOf("java.lang.Throwable") >= 0) || endLineNumber != null && endLineNumber instanceof <any>Error) || endLineNumber === null) && endColumnNumber === undefined && cause === undefined) {
            let __args = Array.prototype.slice.call(arguments);
        ...
        } else if(((typeof description === 'string') || description === null) && ((template != null && template instanceof <any>Template) || template === null) && ((typeof lineNumber === 'number') || lineNumber === null) && ((typeof columnNumber === 'number') || columnNumber === null) && endLineNumber === undefined && endColumnNumber === undefined && cause === undefined) {
            let __args = Array.prototype.slice.call(arguments);
            {
                let __args = Array.prototype.slice.call(arguments);
                let cause : any = null;
        ...
        } else if(((typeof description === 'string') || description === null) && ((template != null && template instanceof <any>Template) || template === null) && ((lineNumber != null && lineNumber instanceof <any>Token) || lineNumber === null) && columnNumber === undefined && endLineNumber === undefined && endColumnNumber === undefined && cause === undefined) {
            let __args = Array.prototype.slice.call(arguments);
            let tk : any = __args[2];
            {
                let __args = Array.prototype.slice.call(arguments);
    ...
    /*private*/ renderMessageAndDescription() {
    ...
    /*private*/ isInJBossToolsMode() : boolean {
     ...
     * @private
     */
    /*private*/ getOrRenderDescription() : string {
        {
    ...
    /*private*/ getCustomTokenErrorDescription() : string {
        ...
        if(kind === FMParserConstants.EOF) {
            ...
            for(let i : number = 0; i < this.expectedTokenSequences.length; i++) {
                ...
                for(let j : number = 0; j < sequence.length; j++) {
                    switch((sequence[j])) {
                    case 42 /* END_FOREACH */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#foreach");
                        break;
                    case 37 /* END_LIST */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#list");
                        break;
                    case 53 /* END_SWITCH */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#switch");
                        break;
                    case 36 /* END_IF */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#if");
                        break;
                    case 51 /* END_COMPRESS */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#compress");
                        break;
                    case 47 /* END_MACRO */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#macro");
                    case 46 /* END_FUNCTION */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#function");
                        break;
                    case 52 /* END_TRANSFORM */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#transform");
                        break;
                    case 71 /* END_ESCAPE */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#escape");
                        break;
                    case 73 /* END_NOESCAPE */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#noescape");
                        break;
                    case 45 /* END_ASSIGN */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#assign");
                        break;
                    case 43 /* END_LOCAL */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#local");
                        break;
                    case 44 /* END_GLOBAL */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#global");
                        break;
                    case 41 /* END_ATTEMPT */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "#attempt");
                        break;
                    case 137 /* CLOSING_CURLY_BRACKET */:
                        /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(endNames, "\"{\"");
                        break;
    ...
    /*private*/ concatWithOrs(endNames : Array<any>) : string {
        let sb : StringBuilder = new StringBuilder("");
        for(let it : any = /* iterator */((a) => { var i = 0; return { next: function() { return i<a.length?a[i++]:null; }, hasNext: function() { return i<a.length; }}})(endNames); it.hasNext(); ) {
