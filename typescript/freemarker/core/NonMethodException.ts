...
export class NonMethodException extends UnexpectedTypeException {
    static EXPECTED_TYPES : Array<any>; public static EXPECTED_TYPES_$LI$() : Array { if(NonMethodException.EXPECTED_TYPES == null) NonMethodException.EXPECTED_TYPES = ["freemarker.template.TemplateMethodModel"]; return NonMethodException.EXPECTED_TYPES; };
