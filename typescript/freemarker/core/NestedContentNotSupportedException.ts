...
export class NestedContentNotSupportedException extends TemplateException {
    public static check(body : TemplateDirectiveBody) {
        ...
        if(body != null && body instanceof <any>Environment.NestedElementTemplateDirectiveBody) {
    ...
    public constructor(description? : any, cause? : any, env? : any) {
        if(((typeof description === 'string') || description === null) && ((cause != null && (cause["__classes"] && cause["__classes"].indexOf("java.lang.Exception") >= 0) || cause != null && cause instanceof <any>Error) || cause === null) && ((env != null && env instanceof <any>Environment) || env === null)) {
        ...
        } else if(((description != null && (description["__classes"] && description["__classes"].indexOf("java.lang.Exception") >= 0) || description != null && description instanceof <any>Error) || description === null) && ((cause != null && cause instanceof <any>Environment) || cause === null) && env === undefined) {
            let __args = Array.prototype.slice.call(arguments);
        ...
        } else if(((typeof description === 'string') || description === null) && ((cause != null && cause instanceof <any>Environment) || cause === null) && env === undefined) {
            let __args = Array.prototype.slice.call(arguments);
            let env : any = __args[1];
            {
                let __args = Array.prototype.slice.call(arguments);
        ...
        } else if(((description != null && description instanceof <any>Environment) || description === null) && cause === undefined && env === undefined) {
            let __args = Array.prototype.slice.call(arguments);
