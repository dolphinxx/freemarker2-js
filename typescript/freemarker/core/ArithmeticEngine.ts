...
import { OptimizerUtil } from '../template/utility/OptimizerUtil';
...
export abstract class ArithmeticEngine {
    ...
    roundingPolicy : number = BigDecimal.ROUND_HALF_UP;
    ...
    public setRoundingPolicy(roundingPolicy : number) {
        if(roundingPolicy !== BigDecimal.ROUND_CEILING && roundingPolicy !== BigDecimal.ROUND_DOWN && roundingPolicy !== BigDecimal.ROUND_FLOOR && roundingPolicy !== BigDecimal.ROUND_HALF_DOWN && roundingPolicy !== BigDecimal.ROUND_HALF_EVEN && roundingPolicy !== BigDecimal.ROUND_HALF_UP && roundingPolicy !== BigDecimal.ROUND_UNNECESSARY && roundingPolicy !== BigDecimal.ROUND_UP) {
     ...
     * @private
     */
    static toBigDecimal(num : number) : BigDecimal {
...
export namespace ArithmeticEngine {
    ...
    export class BigDecimalEngine extends ArithmeticEngine {
        ...
        public divide$java_math_BigDecimal$java_math_BigDecimal(left : BigDecimal, right : BigDecimal) : BigDecimal {
    ...
    export class ConservativeEngine extends ArithmeticEngine {
        ...
        static toBigInteger(num : number) : BigInteger {
