...
export class NonBooleanException extends UnexpectedTypeException {
    static EXPECTED_TYPES : Array<any>; public static EXPECTED_TYPES_$LI$() : Array { if(NonBooleanException.EXPECTED_TYPES == null) NonBooleanException.EXPECTED_TYPES = ["freemarker.template.TemplateBooleanModel"]; return NonBooleanException.EXPECTED_TYPES; };
