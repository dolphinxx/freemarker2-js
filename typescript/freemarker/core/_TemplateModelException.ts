    ...
    public constructor(blamed? : any, cause? : any, env? : any, ...descriptionParts : any[]) {
        if(arguments.length === 4) {
            ...
            if(arguments[0] instanceof Expression) {
                cause = null;
                env = arguments[1];
                descriptionParts = arguments[2];
                super(cause, env, new _ErrorDescriptionBuilder(descriptionParts).blame(blamed), true);
            } else {
                super(arguments[0], arguments[1], Array.isArray(arguments[2])?new _ErrorDescriptionBuilder(arguments[2]):arguments[2], true);
            }
        } else if(arguments.length === 2) {
            if(arguments[0] instanceof Expression) {
                super(null, null, new _ErrorDescriptionBuilder(descriptionParts).blame(blamed), true);
            } else if(ClassUtil.isAssignableFrom(arguments[0], 'freemarker.core.Environment')) {
                if(Array.isArray(arguments[1]) || typeof arguments[1] === 'string') {
                    super(null, arguments[0], new _ErrorDescriptionBuilder(arguments[1]), true);
                } else {
                    super(null, arguments[0], arguments[1], true);
                }
            } else {
                if(Array.isArray(arguments[1]) || typeof arguments[1] === 'string') {
                    super(arguments[0], null, new _ErrorDescriptionBuilder(descriptionParts), true);
                } else {
                    super(arguments[0], arguments[1], null, true);
                }
            }
        } else {
            if(Array.isArray(arguments[0]) || typeof arguments[0] === 'string') {
                super(null, null, new _ErrorDescriptionBuilder(arguments[0]), true);
            } else if(arguments[0] instanceof _ErrorDescriptionBuilder) {
                super(null, null, arguments[0], true);
            } else {
                super(arguments[0], null, null, true);
            }
        }
