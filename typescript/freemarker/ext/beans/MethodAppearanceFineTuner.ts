 ...
 * @class
 */
export interface MethodAppearanceFineTuner {
    /**
     ...
     * 
     * @param {BeansWrapper.MethodAppearanceDecisionInput} in  Describes the method about which the decision will have to be made.
     * @param {BeansWrapper.MethodAppearanceDecision} out Stores how the method will be exposed in the
