 ...
 * @class
 */
export interface TemplateDirectiveModel extends TemplateModel {
    /**
     ...
     * 
     * @param {Environment} env      the current processing environment. Note that you can access
     * the output {link java.io.Writer Writer} by {link Environment#getOut()}.
     * @param {Map} params   the parameters (if any) passed to the directive as a
     ...
     * @param {Array} loopVars an array that corresponds to the "loop variables", in
