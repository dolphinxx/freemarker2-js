...
export class CollectionUtils {
     ...
     * @since 2.3.22
     */
    public static EMPTY_CHAR_ARRAY : string[]; public static EMPTY_CHAR_ARRAY_$LI$() : string[] { if(CollectionUtils.EMPTY_CHAR_ARRAY == null) CollectionUtils.EMPTY_CHAR_ARRAY = []; return CollectionUtils.EMPTY_CHAR_ARRAY; };
}
CollectionUtils["__class"] = "freemarker.template.utility.CollectionUtils";
...
CollectionUtils.EMPTY_CLASS_ARRAY_$LI$();

CollectionUtils.EMPTY_OBJECT_ARRAY_$LI$();
