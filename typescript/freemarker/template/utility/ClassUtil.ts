...
import { BooleanModel } from '../../ext/beans/BooleanModel';
import { CollectionModel } from '../../ext/beans/CollectionModel';
import { DateModel } from '../../ext/beans/DateModel';
import { EnumerationModel } from '../../ext/beans/EnumerationModel';
import { IteratorModel } from '../../ext/beans/IteratorModel';
import { MapModel } from '../../ext/beans/MapModel';
import { NumberModel } from '../../ext/beans/NumberModel';
...
import { StringModel } from '../../ext/beans/StringModel';
...
import { TemplateDirectiveModel } from '../TemplateDirectiveModel';
...
import { TemplateNodeModelEx } from '../TemplateNodeModelEx';
...
export class ClassUtil {
     ...
     * @private
     */
    static getPrimaryTemplateModelInterface(tm : TemplateModel) : any {
        if(tm != null && tm instanceof <any>BeanModel) {
            if(tm != null && tm instanceof <any>CollectionModel) {
                return "freemarker.template.TemplateSequenceModel";
            } else if((tm != null && tm instanceof <any>IteratorModel) || (tm != null && tm instanceof <any>EnumerationModel)) {
                return "freemarker.template.TemplateCollectionModel";
            } else if(tm != null && tm instanceof <any>MapModel) {
                return "freemarker.template.TemplateHashModelEx";
            } else if(tm != null && tm instanceof <any>NumberModel) {
                return "freemarker.template.TemplateNumberModel";
            } else if(tm != null && tm instanceof <any>BooleanModel) {
                return "freemarker.template.TemplateBooleanModel";
            } else if(tm != null && tm instanceof <any>DateModel) {
                return "freemarker.template.TemplateDateModel";
            } else if(tm != null && tm instanceof <any>StringModel) {
                let wrapped : any = (<BeanModel><any>tm).getWrappedObject();
        ...
        } else if((tm != null && tm instanceof <any>SimpleMethodModel) || (tm != null && tm instanceof <any>OverloadedMethodsModel)) {
    ...
    static getUnwrappedClass(tm : TemplateModel) : any {
        let unwrapped : any;
        try {
            if(tm != null && (tm["__interfaces"] != null && tm["__interfaces"].indexOf("freemarker.ext.util.WrapperTemplateModel") >= 0 || tm.constructor != null && tm.constructor["__interfaces"] != null && tm.constructor["__interfaces"].indexOf("freemarker.ext.util.WrapperTemplateModel") >= 0)) {
                unwrapped = (<WrapperTemplateModel><any>tm).getWrappedObject();
                ...
                unwrapped = (<AdapterTemplateModel><any>tm).getAdaptedObject(Object);
            } else {
                unwrapped = null;
            }
        } catch(e) {
    ...
    static appendTypeName(sb : StringBuilder, typeNamesAppended : Array<any>, name : string) {
        if(!/* contains */(typeNamesAppended.indexOf(<any>(name)) >= 0)) {
            ...
            sb.append(name);
            /* add */((s, e) => { if(s.indexOf(e)==-1) { s.push(e); return true; } else { return false; } })(typeNamesAppended, name);
        }
    }
     ...
     * @return {String}
     */
    public static getFTLTypeDescription(tm : TemplateModel) : string {
        if(tm == null) {
            return "Null";
        } else {
            ...
            if(tm != null && tm instanceof <any>Macro) {
                ClassUtil.appendTypeName(sb, typeNamesAppended, (<Macro><any>tm).isFunction()?"function":"macro");
            }
    ...
    public static primitiveClassToBoxingClass(primitiveClass : any) : any {
        ...
        if(primitiveClass === Number) return Number;
        if(primitiveClass === Number) return Number;
        if(primitiveClass === void) return "java.lang.Void";
    ...
    public static boxingClassToPrimitiveClass(boxingClass : any) : any {
        ...
        if(boxingClass === Number) return Number;
        if(boxingClass === Number) return Number;
        if(boxingClass === "java.lang.Void") return void;
        return boxingClass;
    }
    ...
    public static isNumerical(type : any) : boolean {
        return Number.isAssignableFrom(type) || /* isPrimitive */(type === <any>'__erasedPrimitiveType__') && type !== javaemul.internal.BooleanHelper.TYPE && type !== javaemul.internal.CharacterHelper.TYPE && type !== void.TYPE;
    }
    ...
    public static getReasourceAsStream$java_lang_ClassLoader$java_lang_String$boolean(classLoader : ClassLoader, resource : string, optional : boolean) : InputStream {
        let ins : InputStream;
        try {
     ...
     * @return {Properties}
     */
    public static loadProperties(baseClass : any, resource : string) : Map {
        let props : Map<any, any> = <Map>new Map();
    ...
    static checkInputStreamNotNull(ins : InputStream, baseClass : any, resource : string) {
        if(ins == null) {
            throw Object.defineProperty(new Error("Class-loader resource not found (shown quoted): " + StringUtil.jQuote$java_lang_Object(resource) + ". The base class was " + /* getName */(c => c["__class"]?c["__class"]:c["name"])(baseClass) + "."), '__classes', { configurable: true, value: ['java.lang.Throwable','java.io.IOException','java.lang.Object','java.lang.Exception'] });
        }
    }
}
