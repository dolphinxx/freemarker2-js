...
export class TemplateModelException extends TemplateException {
    /*private*/ replaceWithCause : boolean;

    public constructor(cause? : any, env? : any, description? : any, preventAmbiguity? : any) {
        if(((cause != null && (cause["__classes"] && cause["__classes"].indexOf("java.lang.Throwable") >= 0) || cause != null && cause instanceof <any>Error) || cause === null) && ((env != null && env instanceof <any>Environment) || env === null) && ((typeof description === 'string') || description === null) && ((typeof preventAmbiguity === 'boolean') || preventAmbiguity === null)) {
        ...
        } else if(((typeof cause === 'string') || cause === null) && ((typeof env === 'boolean') || env === null) && ((description != null && (description["__classes"] && description["__classes"].indexOf("java.lang.Throwable") >= 0) || description != null && description instanceof <any>Error) || description === null) && preventAmbiguity === undefined) {
            let __args = Array.prototype.slice.call(arguments);
        ...
        } else if(((typeof cause === 'string') || cause === null) && ((env != null && (env["__classes"] && env["__classes"].indexOf("java.lang.Exception") >= 0) || env != null && env instanceof <any>Error) || env === null) && description === undefined && preventAmbiguity === undefined) {
            let __args = Array.prototype.slice.call(arguments);
            let description : any = __args[0];
