...
export class _TemplateAPI {
    ...
    public static checkVersionNotNullAndSupported(incompatibleImprovements : Version) {
        ...
        if(iciV > (require('./Configuration').Configuration).getVersion().intValue()) {
            throw Object.defineProperty(new Error("The FreeMarker version requested by \"incompatibleImprovements\" was " + incompatibleImprovements + ", but the installed FreeMarker version is only " + (require('./Configuration').Configuration).getVersion() + ". You may need to upgrade FreeMarker in your project."), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.IllegalArgumentException','java.lang.Exception'] });
        }
        if(iciV < /*_TemplateAPI.VERSION_INT_2_3_0_$LI$()*/2003000) {
    ...
    public static getTemplateLanguageVersionAsInt(to? : any) : any {
        ...
        } else if(((to != null && to instanceof <any>(require('./Template').Template)) || to === null)) {
            return <any>_TemplateAPI.getTemplateLanguageVersionAsInt$freemarker_template_Template(to);
        } else throw new Error('invalid overload');
    }

    public static getTemplateLanguageVersionAsInt$freemarker_template_Template(t : /*Template*/any) : number {
    ...
    public static getDefaultTemplateExceptionHandler(incompatibleImprovements : Version) : TemplateExceptionHandler {
        return (require('./Configuration').Configuration).getDefaultTemplateExceptionHandler(incompatibleImprovements);
    }

    public static getDefaultAttemptExceptionReporter(incompatibleImprovements : Version) : AttemptExceptionReporter {
        return (require('./Configuration').Configuration).getDefaultAttemptExceptionReporter(incompatibleImprovements);
    }

    public static getDefaultLogTemplateExceptions(incompatibleImprovements : Version) : boolean {
        return (require('./Configuration').Configuration).getDefaultLogTemplateExceptions(incompatibleImprovements);
    }

    public static getDefaultWrapUncheckedExceptions(incompatibleImprovements : Version) : boolean {
        return (require('./Configuration').Configuration).getDefaultWrapUncheckedExceptions(incompatibleImprovements);
    }

    public static createDefaultTemplateLoader(incompatibleImprovements : Version) : TemplateLoader {
        return (require('./Configuration').Configuration).createDefaultTemplateLoader(incompatibleImprovements);
    }

    public static createDefaultCacheStorage(incompatibleImprovements : Version) : CacheStorage {
        return (require('./Configuration').Configuration).createDefaultCacheStorage$freemarker_template_Version(incompatibleImprovements);
    }

    public static getDefaultTemplateLookupStrategy(incompatibleImprovements : Version) : TemplateLookupStrategy {
        return (require('./Configuration').Configuration).getDefaultTemplateLookupStrategy(incompatibleImprovements);
    }

    public static getDefaultTemplateNameFormat(incompatibleImprovements : Version) : TemplateNameFormat {
        return (require('./Configuration').Configuration).getDefaultTemplateNameFormat(incompatibleImprovements);
    }
     ...
     * @return {Set}
     */
    public static getConfigurationSettingNames(cfg : /*Configuration*/any, camelCase : boolean) : Array<any> {
        return cfg.getSettingNames(camelCase);
    }

    public static setAutoEscaping(t : /*Template*/any, autoEscaping : boolean) {
        t.setAutoEscaping(autoEscaping);
    }

    public static setOutputFormat(t : /*Template*/any, outputFormat : OutputFormat) {
    ...
    public static getBlamedExpression(e : TemplateException) : /*Expression*/any {
        return e.getBlamedExpression();
    }

    public static getDefaultLocale() : string {
        return (require('./Configuration').Configuration).getDefaultLocale();
    }

    public static getDefaultTimeZone() : string {
        return (require('./Configuration').Configuration).getDefaultTimeZone();
    }

    public static setPreventStrippings(conf : /*Configuration*/any, preventStrippings : boolean) {
