...
export class TemplateCache {
    ...
    static LOG : Logger; public static LOG_$LI$() : Logger { if(TemplateCache.LOG == null) TemplateCache.LOG = Logger.getLogger("freemarker.cache"); return TemplateCache.LOG; };
    ...
    /*private*/ templateConfigurations : TemplateConfigurationFactory;

    /*private*/ isStorageConcurrent : boolean;

    /**
     * {link Configuration#setTemplateUpdateDelayMilliseconds(long)}
     */
    /*private*/ updateDelay : number = TemplateCache.DEFAULT_TEMPLATE_UPDATE_DELAY_MILLIS;

    /**
     * {link Configuration#setLocalizedLookup(boolean)}
     */
    /*private*/ localizedLookup : boolean = true;
    ...
    getTemplateInternal(name : string, locale : string, customLookupCondition : any, encoding : string, parseAsFTL : boolean) : Template {
        ...
        try {
            if(cachedTemplate != null) {
                ...
                let sourceEquals : boolean = /* equals */(<any>((o1: any, o2: any) => { if(o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(newLookupResultSource,cachedTemplate.source));
    ...
    newIOException(message : string, cause : Error) : Error {
        if(cause == null) {
            return Object.defineProperty(new Error(message), '__classes', { configurable: true, value: ['java.lang.Throwable','java.io.IOException','java.lang.Object','java.lang.Exception'] });
        }
        let ioe : Error;
    ...
    public removeTemplate$java_lang_String$java_util_Locale$java_lang_Object$java_lang_String$boolean(name : string, locale : string, customLookupCondition : any, encoding : string, parse : boolean) {
        if(name == null) {
            throw Object.defineProperty(new Error("Argument \"name\" can\'t be null"), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.IllegalArgumentException','java.lang.Exception'] });
        }
        if(locale == null) {
            throw Object.defineProperty(new Error("Argument \"locale\" can\'t be null"), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.IllegalArgumentException','java.lang.Exception'] });
        }
        if(encoding == null) {
            throw Object.defineProperty(new Error("Argument \"encoding\" can\'t be null"), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.IllegalArgumentException','java.lang.Exception'] });
        }
        name = this.templateNameFormat.normalizeRootBasedName(name);
    ...
    lookupTemplate(name : string, locale : string, customLookupCondition : any) : TemplateLookupResult {
        ...
        if(lookupResult == null) {
            throw Object.defineProperty(new Error("Lookup result shouldn\'t be null"), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.NullPointerException','java.lang.Exception'] });
        }
        return lookupResult;
    }
    ...
    lookupTemplateWithAcquisitionStrategy(path : string) : TemplateLookupResult {
        ...
        while((tok.hasMoreTokens())) {
            ...
            if(/* equals */(<any>((o1: any, o2: any) => { if(o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(pathToken,TemplateCache.ASTERISKSTR))) {
                if(lastAsterisk !== -1) {
                    /* remove */tokpath.splice(lastAsterisk, 1);
                }
        ...
        if(/* endsWith */((str, searchString) => { let pos = str.length - searchString.length; let lastIndex = str.indexOf(searchString, pos); return lastIndex !== -1 && lastIndex === pos; })(resourcePath, "/")) {
...
export namespace TemplateCache {
    ...
    export class TemplateKey {
        ...
        nullSafeEquals(o1 : any, o2 : any) : boolean {
            return o1 != null?(o2 != null && /* equals */(<any>((o1: any, o2: any) => { if(o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(o1,o2))):o2 == null;
        }
    ...
    export class TemplateCacheTemplateLookupContext extends TemplateLookupContext {
        ...
        public lookupWithAcquisitionStrategy(name : string) : TemplateLookupResult {
            if(/* startsWith */((str, searchString, position = 0) => str.substr(position, searchString.length) === searchString)(name, "/")) {
                throw Object.defineProperty(new Error("Non-normalized name, starts with \"/\": " + name), '__classes', { configurable: true, value: ['java.lang.Throwable','java.lang.Object','java.lang.RuntimeException','java.lang.IllegalArgumentException','java.lang.Exception'] });
            }
